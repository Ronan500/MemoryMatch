...
$(document).ready(function() {
  var $game = $('#game');
  var values = MemoryMatch.generateCardValues();
  MemoryMatch.renderCards(values, $game);
});
...
MemoryMatch.generateCardValues = function () {
...
MemoryMatch.renderCards = function(cardValues, $game) {
  var colors = [
    'hsl(25, 85%, 65%)',
    'hsl(55, 85%, 65%)',
    'hsl(90, 85%, 65%)',
  ...
  $('.card').click(function() {
    MemoryMatch.flipCard($(this), $('#game'));
  });
};
...
MemoryMatch.flipCard = function($card, $game) {
